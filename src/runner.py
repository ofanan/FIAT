            ...
            for mode in ['salsa0']:
                for missp in [30]: #[10, 30, 100, 300]:
                    ...
                    sm = sim.DistCacheSimulator(
                        ...
                        verbose                 = [MyConfig.VERBOSE_RES, MyConfig.VERBOSE_FULL_RES, MyConfig.VERBOSE_DETAILED_LOG_MR]) #MyConfig.VERBOSE_DETAILED_LOG_MR]) # [MyConfig.VERBOSE_RES, MyConfig.VERBOSE_FULL_RES, ])
