...
for trace_file_name in traces:
    run_var_missp_sim(trace_file_name=trace_file_name, max_num_of_req=1000000, modes=['fnaa', 'opt'], missp_vals=[10, 30, 100, 300], verbose=[MyConfig.VERBOSE_RES, MyConfig.VERBOSE_FULL_RES])
