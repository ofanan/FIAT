...
for trace_file_name in traces:
    run_var_missp_sim (max_num_of_req = 400000, trace_file_name=trace_file_name, DS_size=10000, modes=['fnaa'], missp_vals=[10], verbose=[MyConfig.VERBOSE_RES, MyConfig.VERBOSE_FULL_RES])
