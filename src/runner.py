...
def main ():
    ...
    for trace in ['IBM1', 'Twitter45', 'F1']: #, 'Scarab','F2', 'Wiki']: #['Twitter', 'IBM', 'Scarab','F2', 'Wiki', 'Twitter45', 'F1', 'IBM1'      
        for DS_size in [4000]: #[4000, 16000, 64000]:
            max_num_of_req = MyConfig.calc_num_of_req (trace, DS_size=DS_size) 
