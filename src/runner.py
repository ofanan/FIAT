...
for trace_file_name in traces:
    run_var_missp_sim(trace_file_name=trace_file_name, max_num_of_req=1000000, modes=['salsa3'], missp_vals=[10], verbose=[MyConfig.VERBOSE_RES, MyConfig.VERBOSE_FULL_RES, MyConfig.VERBOSE_LOG_Q])
